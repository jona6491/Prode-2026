    ...
    <div style={{padding:'12px 14px', overflowY:'auto', flex:1}}>
      <div className="rules-block" style={{background:'var(--bg2)', border:'1px solid var(--bd)', borderRadius:11, overflow:'hidden', marginBottom:10}}>
        ...
        {[
          ...
          ['✗ Fallo total', 'No acertás ni el resultado ni los goles', '0 puntos', '#5e6480', 'rgba(255,255,255,.07)'],
      ...
      <div className="rules-block" style={{background:'var(--bg2)', border:'1px solid var(--bd)', borderRadius:11, overflow:'hidden', marginBottom:10}}>
        ...
        {[
          ...
          ['👁️', 'El ranking es visible para todos en tu grupo'],
          ['🏆', 'Clasifican los 2 primeros de cada grupo + 8 mejores terceros (32 equipos)'],
        ].map(([icon, text]) => (
      ...
      <div style={{padding:'12px 14px', background:'var(--bg2)', border:'1px solid var(--bd)', borderRadius:11, fontSize:12, color:'var(--tx3)', textAlign:'center'}}>
